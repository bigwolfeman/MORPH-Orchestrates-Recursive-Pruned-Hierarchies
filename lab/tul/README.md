# Lab — TUL campaign notes

Run comparisons, RCAs, and spike evals for Thought Unpack Loop. Not production
specs and not Agent Notes.

| File | What |
|---|---|
| [arms-result.md](arms-result.md) | First complete A0c/A1c arm comparison (2026-08-18) |
...
Arm CW (implemented): [`.agents/notes/archived/architecture/2026-08-18-tul-compaction-window.md`](../.agents/notes/archived/architecture/2026-08-18-tul-compaction-window.md).
