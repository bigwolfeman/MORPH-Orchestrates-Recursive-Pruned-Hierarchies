...
| E16 | the Olympiad curriculum panel: mask, notul, mnext, a1 on synthetic math, 6k steps in four 1500-step band stages (2–5 → 11–13, ~15 % replay), effective batch 24, the held-out shard as val, the audit's levers (`ckpt_grad_iters 4`; `tg_scoped_kernels` on the mask arm) (configs `tul_oly_*`, `notul_oly`, `oly_data.yaml`; runner `arc/run_e16.sh`) | PLANNED `planned/2026-09-08-arc-e16-olympiad-curriculum-panel.md` (frozen 2026-09-08; launch is Wolfe's call). Pit stop: `lab/perf/2026-09-08-oly-throughput-audit/` (2.03x on the mask arm; the hinge reads +0.07 of noise on the eager path, `.agents/notes/proposed/bug-fix/2026-09-08-slot-gain-eps-noise-bias.md`). |
