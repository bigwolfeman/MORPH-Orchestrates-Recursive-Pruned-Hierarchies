...
| density | The production prune density on the Parcae-entry recipe (Wolfe 2026-09-09: "we need to test density"): `density-half` and `density-quarter` (prune only from step 1500, interval 25, rate 0.03; no carve, no routing), scored on the K-curve, token-paired CE vs the dense Parcae-entry arm, and the depth-1 price | PLANNED `planned/2026-09-09-arc-density-panel.md` (frozen 2026-09-09; chained behind the depth-candidates panel). |
