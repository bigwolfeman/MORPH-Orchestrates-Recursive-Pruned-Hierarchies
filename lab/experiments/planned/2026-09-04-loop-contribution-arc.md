...
| horizon | Does the ternary loop's contribution change over training? `horizon-ternary-25k` (the Parcae-entry recipe for 25,000 steps, K-curve + anatomy at every 5k checkpoint; an old long-horizon checkpoint swept first if one exists) | PLANNED `planned/2026-09-09-arc-horizon-ternary-25k.md` (frozen 2026-09-09; Wolfe: "25k steps in ternary on open web data to see if this changes over time"). |
