...
| E9 | widen the diagonal carry to all 768 dims (`model.injection_channels: all`; `notul_carry_all.yaml` + control `notul_carry_ctx_wu0.yaml`; prereg `arc-e9-widen-the-carry.md`) under the warmup-0 detonation assay, 6 + 3 draws | code + tests done 2026-09-07 03:05 (Wolfe: "we wanna try widening the diag carry"); queued behind E8 in `arc/run_e9.sh` |
