...
| E14 | the expansive dial: E13's mask arm with the gain hinge at 1.02, with and without `slot_state_renorm` (configs `tul_m12_mask_g102*.yaml`; prereg `arc-e14-expansive-dial.md`; Wolfe 2026-09-07: let the map get a touch over 1.0 so it CAN be expansive) | queued behind E13 in `arc/run_e14.sh` 2026-09-07 |
