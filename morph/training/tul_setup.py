...
KNOWN_TUL_KEYS = frozenset({
    ...
    "gate_truncate_p", "max_slots", "min_span", "mux_activate_at", "mux_beta",
    "mux_detach_head", "mux_rho", "mux_stage_own_iters", "mux_target", "mux_tau",
    "per_slot_embed",
    ...
    "sigreg_slices", "slot_max_depth", "slot_mean_depth", "slot_seed", "slot_token",
