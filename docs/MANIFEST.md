...
- [The takeover is a forward state collapse](experiments/failures/2026-08-24-tul-takeover-cure.md) — the slot states are near-degenerate by design and the loop starts collapsing them at the onset; four weight-space cures fail
