...
- **MORPH uses:** The StarCoder2 tokenizer (49,152-vocabulary BPE, fill-in-the-middle capable, 600+ programming languages) for code data in MORPH's mixed OpenWebText + code pretraining. The 49k vocab cleanly stacks with a bigram hash-vocab prefix for rare byte patterns.
