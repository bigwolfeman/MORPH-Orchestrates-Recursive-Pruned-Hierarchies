...
- **MORPH uses:** UNDER EVALUATION, nothing built. Two separable ideas. (1) The
  **recurrent-depth mode** (§5.5, App. E.5): read MORPH's core loop as a reverse-diffusion
  ...
  case it explicitly does **NOT** partition into blocks. See
  `../../diffusionblocks-morph-assessment.md` for what does and does not transfer.
