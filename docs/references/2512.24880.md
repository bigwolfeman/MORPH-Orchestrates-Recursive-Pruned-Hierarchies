...
- **MORPH uses:** mHC uses n parallel full-C-dim streams with an n x n doubly-stochastic mixing matrix (Sinkhorn-Knopp, Birkhoff polytope), plus aggregation (H^pre) and distribution (H^post) vectors with dynamic input-dependent gating.
