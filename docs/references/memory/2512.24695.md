...
- **MORPH uses:** Nested Learning optimization with learned, multi-timescale momentum (Continuum Memory System). The original optimizer for this project was based on this paper. The multi timescale momentum was repurposed else where in the project, and the optimizer was replaced with AdEMAmix.
