...
\node[B, fill=fBlue, below=0.95cm of normA, minimum width=6.4cm, inner sep=6pt] (attn) {
...
\node[B, fill=fPurple, left=1.1cm of attn, minimum width=3.0cm, inner sep=6pt] (gla) {
  GLA retention\\[1pt]{\scriptsize branch (layer 1)}\\[2pt]
...
\draw[A] (preM) -- (normM);
\node[B, fill=fOrange, below=0.85cm of normM, minimum width=6.4cm, inner sep=6pt] (mlp) {
  SwiGLU MLP\\[2pt]
...
\node[draw=hcC, very thick, rounded corners=6pt, fill=hcC!6,
      anchor=north west, text width=6.1cm, inner sep=10pt,
