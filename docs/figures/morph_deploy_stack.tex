...
%
% NOTE: this diagram tracks base.yaml's deploy-oriented defaults: ternary MLP/backbone
% weights, int6 Euclidean/bigram embeddings, bf16 attention/normalization/carriers, and
% 8-bit AdamW optimizer state during training.
