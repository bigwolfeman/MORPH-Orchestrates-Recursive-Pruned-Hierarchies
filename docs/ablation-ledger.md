...
| TUL-spec | plan span-specificity | `plan_shuffled` vs `plan_off` (no training) | is the plan CONTENT read, or just its positions? | **RUN** 2026-08-28 on 7 checkpoints. **The restriction destroys the plan's content: 65.1% (no restriction) → 3.0% (restriction) at MATCHED aux losses.** Every restricted arm 0.1–0.6%. The coda gains 0.037–0.123 nats from the slot path and ~none of it depends on which span wrote the plan. [experiment](../lab/experiments/planned/2026-08-28-plan-span-specificity.md) |
