...
# MORPH Perf Pass — Phase 3 Plan (agreed with Wolfe 2026-07-03, pre-compaction)
...
interop soft. Wolfe context: the BCSR/megablocks kernels DID show real improvements
...
1. **ncu the stk kernels** at real shapes ([16384,768]×[768,4096] @ 0.25 BCSR,
   ...
   evidence + tile-prover schedule proofs, Wolfe opts in.
