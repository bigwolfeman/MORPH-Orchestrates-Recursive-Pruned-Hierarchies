...
| 3 | TUL on (`tul_a1`) | **×1.6 measured** (28.1k tok/s, slightly better CE, `lab/tul/arms-result.md`) | validated on the 5090 arms; not validated with prune/carve/route | measured |
