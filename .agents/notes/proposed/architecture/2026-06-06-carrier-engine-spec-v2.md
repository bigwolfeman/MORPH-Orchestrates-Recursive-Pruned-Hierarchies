# Agent Note: Carrier Engine Spec V2

Status: proposed

Origin: Ai-notes/06-06-2026/MORPH-Megakernel-Plan/spec_v2_carrier_engine.md
...
1. **"No training-megakernel backward" was overstated → RETRACTED.** FlashAttention is a
 ...
 forbidden** (the hypothesis, correct). And tonight I hand-derived a fused glue-backward
