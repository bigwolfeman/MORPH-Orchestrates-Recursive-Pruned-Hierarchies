...
⚠️ n=4 is LOCKED. Do NOT propose n=2: measured a quality regression from n=2 and it's only
...
## 32-BIT EMBEDDING PICKUP (separate, smaller — : "might be a good pickup")
