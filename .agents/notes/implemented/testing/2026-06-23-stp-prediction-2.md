...
**Question (prediction 2):** "[STP pretraining] will be more repetitive than without.
...
- **Single recipe.** 42 steps, packed stream, flat LR 2e-5, AdamW8bit, 512 examples. Gentler
 ...
 recipe described destabilizes this model, NOT that "SFT can never help MORPH."
...
- **Model is genuinely weak** (276M, ternary, 0.25 density, looped) — even the bases are barely
 coherent. 's "how dumb it is" prior is well supported; this caps what any SFT can show.
