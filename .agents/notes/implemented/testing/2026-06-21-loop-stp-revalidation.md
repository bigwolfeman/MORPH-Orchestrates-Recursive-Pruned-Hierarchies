...
**Date:** 2026-06-21
**Trigger:** — "we need to test the stp on loop. I know this has been tested
...
## Follow-on (, same session): "test stp off completely"
...
~70 min, one GPU arm. NOT launched yet (GPU was needed ~1hr).
