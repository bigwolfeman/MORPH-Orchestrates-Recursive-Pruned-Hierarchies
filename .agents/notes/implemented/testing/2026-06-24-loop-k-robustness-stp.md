...
**Reframe :** the paper is, for MORPH, a **loop-k robustness** paper. The looped weight-tied
...
1. **No cliff in the 50k regime.** Both deployed models degrade *gracefully*; k=16 (2× trained
 ...
 concentrates at k≤3. (the remembered "cliff to 0" is not present here in [1,16] — likely a
