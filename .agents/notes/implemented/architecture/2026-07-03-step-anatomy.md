...
**Constraints (Wolfe):** HARD — bit-exact: same config+seed ⇒ identical loss/param
...
**Optimizer under test: `ademamix_b1zero` FUSED (dynamic qmap)** — Wolfe 2026-07-03:
...
### Class B — numerics-changing (surface to Wolfe with evidence; opt-in flag + parity gate)
