...
- **NON-goals (decoupled 2026-06-12):**
...
- **Precision `[OPEN — recommend dense bf16 for this run]`:** to isolate the *curriculum* mechanics
 ...
 vet data/context machinery). locked decision.
...
## 2. Data — "everything local" blend (: "everything local")
...
## 4. Curriculum + RoPE context ramp (the heart — 's directives)
...
- If even micro-batch 1 OOMs at 32K → **surface ** (options: cap curriculum at 16K for the
