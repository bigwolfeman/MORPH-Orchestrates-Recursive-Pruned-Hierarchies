# Agent Note: Eval Recompile Hang

Status: implemented

Origin: Ai-notes/06-01-2026/MORPH-eval-recompile-hang/findings.md
...
shapes). The py-spy stack captured on the wedged campaign was decisive and redirected
...
sudo blocked py-spy/gdb (trainer isn't my process ancestor, I'm not root, operator away). So
...
## Proper fix (DAYTIME, needs operator / root)
...
crosses 200+ then kernels_b4/b8. Memory note 's question: eager ~31 GiB is the
...
### RECOMMENDED REAL FIXES (to choose — ranked)
