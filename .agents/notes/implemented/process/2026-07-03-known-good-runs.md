# Agent Note: Known Good Runs

Status: implemented

Origin: Ai-notes/known-good-runs.md
...
[ablation-ledger.md](../../../../docs/ablation-ledger.md).
...
Phase coupling and gotchas: [runtime-invariants.md](../../../../docs/runtime-invariants.md).
